...
"use strict";
define([
    "basic/separate-word-search", "basic/context-array", "basic/filter"
], function () {
    describe("basic mark with duplicated keywords", function () {
        ...
        beforeEach(function (done) {
            ...
            new Mark($ctx1[0]).mark(["test", "test"], {
                ...
                "filter": function () {
                    ctx1Called++;
                    // return false. Otherwise matches would become wrapped and
                    // no further matches would be found. Therefore no further
                    // filter calls would be done
                    return false;
                },
                "done": function () {
                    new Mark($ctx2[0]).mark("lorem test ipsum", {
                        ...
                        "filter": function () {
                            ctx2Called++;
                            // return false. Otherwise matches would become
                            // wrapped and no further matches would be found.
                            // Therefore no further filter calls would be done
                            return false;
                        },
                        "done": done
                    });
        ...
        it(
            "should ignore duplicated keywords with separateWordSearch",
            function () {
