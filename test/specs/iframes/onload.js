...
define(function () {
    describe("mark with iframes where onload was not fired yet", function () {
        ...
        // is that Chrome initializes every iframe with an empty page, which
        // will fire the onload event too respectively set readyState complete
        ...
        it("should wrap matches inside iframes", function () {
            ...
            $elements.each(function () {
                var $th = $(this);
                if($th.prop("ownerDocument") !== $ctx.prop("ownerDocument")) {
                    unequal = true;
                }
            });
